...
## 2. Add a Dockerfile for backend development
...
## 3. Add the backend service to compose.yaml
...
## 4. Update the Next.js app to display the backend Git SHA
...
## 7. Add backend security group to persistent IaC
...
## 8. Add backend ECS Express Gateway service to ephemeral IaC
...
## 9. Update IaC workflow environment variables
...
## 10. Update .env with backend URL variable
